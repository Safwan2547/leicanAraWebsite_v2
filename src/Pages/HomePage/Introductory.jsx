...
return(
    ...
    flex just sm:mt-16 sm:mb-32`}>
     ...
     <p id='introductoryDescription' className={`opacity-0 font-Satoshi  textP text-balance hyphens-auto max-w-[35em] ${marginExpression3} font-light  text-sm sm:text-2xl`} >Our mission at LeicanAra is to create captivating designs that help our partners share their unique stories with the world. We aim to provide businesses with a soul, crafting brands that truly connect with and inspire customers. </p>
      </div>
