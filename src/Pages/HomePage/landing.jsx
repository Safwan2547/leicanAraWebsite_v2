...
<div className="z-1   w-screen h-screen absolute outline-none ">
      ...
      <h1  className={`landingItem1  text-5xl  sm:text-6xl w-3/4 font-Lora font-light text-center  opacity-0 sm:w-1/3 z-10 text-NightFall   
         sm:hidden textC transition duration-200 `}>
          ...
          <h1 data-scroll id='hero_line'  className={` textC mb-5 opacity-0 landingItem1 font-normal text-NightFall font-Lora sm:text-9xl  leading-none`}>
          Storytellers for the Visionaries
          </h1>
