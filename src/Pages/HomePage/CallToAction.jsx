...
return(<div className=" border-black border-0 border-solid flex justify-center items-center h-[50vh] w-[100%]  ">
    ...
    flex-col items-start justify-center align-top     ">
        <h1 className="text-5xl textC font-Lora  opacity-0 text-NightFall mb-10 text-center">Ready to turn your ideas into art?</h1>
        <a href="#" className=" opacity-0  underline hover:animate-pulse-slow buttonC hover:scale-105 hover:text-LunarDawn transition-color
         cursor-none font-Satoshi underline-offset-8 font-extralight text-NightFall text-left text-4xl">Lets work together!</a>
