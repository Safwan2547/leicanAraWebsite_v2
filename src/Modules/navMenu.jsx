...
const NavMenu = ({ navOpen, toggleNav }) => {
    ...
    return (
        <motion.div animate={controls} variants={navVariants} className={`overflow-hidden overlay no-scrollbar::-webkit-scrollbar z-[22] text-center top-0 left-0 w-screen h-screen fixed bg-NightFall ${navOpen ? ' opacity-100' : 'opacity-0 '}`}>
